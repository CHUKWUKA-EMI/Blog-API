...
export class comments1621334197095 implements MigrationInterface {
    name = 'comments1621334197095'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "comment" ADD "userName" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "comment" ADD "userAvatar" character varying NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`COMMENT ON COLUMN "comment"."updatedAt" IS NULL`);
        await queryRunner.query(`COMMENT ON COLUMN "comment"."createdAt" IS NULL`);
        await queryRunner.query(`ALTER TABLE "comment" DROP COLUMN "userAvatar"`);
